...
export declare abstract class PathScurryBase {
    ...
    iterateSync(eуәлігіңізді қорғайды. Edge браузері соңғы шолғыш журналыңыздың негізінде қызықтыратын тақырыптарды жазып ала алады. Кейінірек сіз кірген сайт сіз көретін жарнамаларды жекелендіру үшін Edge браузерінен қатысты тақырыптарды сұрауы мүмкін.Параметрлерде жарнама тақырыптарын көре және сайттармен бөліскіңіз келмейтіндерін блоктай аласыз. Сонымен бірге Edge браузері 4 аптадан ескірек жарнама тақырыптарын автоматты түрде жояды.Жарнама тақырыптары туралы қосымша мәліметтерEdge параметрлерінде ойыңызды кез келген уақытта өзгерте аласызОны қосу<b>Қай деректер пайдаланылады:</b> жарнама тақырыптары соңғы шолғыш журналына, сіз осы құрылғыда Edge арқылы кірген сайттар тізіміне негізделеді.<b>Бұл деректерді пайдалану жолымыз:</b> Edge браузері сіз шолып жатқанда қызықтыратын тақырыптарды жазып алады. Тақырып белгілері алдын ала анықталады және мыналар сияқты нәрселерді қамтиды: «Өнер және ойын-сауық», «Сатып алу» және «Спорт». Кейінірек сіз кірген сайт сіз көретін жарнамаларды жекелендіру үшін Edge браузерінен тақырыптарыңыздың біразын сұрауы мүмкін (бірақ шолғыш журналын сұрамайды).<b>How you can manage your data:</b> Edge браузері 4 аптадан ескірек тақырыптарды автоматты түрде жояды. Сіз шолуды жалғастырғанда, тақырып тізімде қайтадан көрінуі мүмкін. Сонымен бірге сіз Edge параметрлерінде кез келген уақытта Edge браузерінің сайттармен бөлісуін қаламайтын тақырыптарды блоктай аласыз және жарнама тақырыптарын өшіре аласыз.Microsoft компаниясының деректеріңізді қорғау жолы туралы қосымша мәліметтерді «Құпиялылық саясаты» құжатында алуға болады.Енді жарнама құпиялылығының басқа да мүмкіндіктері қолжетімдіСізге жекелендірілген жарнамаларды көрсеткенде сайттар сіз туралы алатын мәліметтерді шектеудің жаңа жолдарын іске қосып жатырмыз:Сайт ұсынатын жарнамалар туралы анықтама шолғыш журналыңызды және сәйкестік куәлігіңізді қорғайды әрі сайттарға сізге қатысты жарнамаларды көрсетуге мүмкіндік береді. Әрекеттеріңіздің негізінде, сіз кірген сайт шолуыңызды жалғастырғанда қатысты жарнамаларды ұсынуы мүмкін. Сіз параметрлерде осы сайттардың тізімін көре аласыз және қаламайтындарыңызды блоктай аласыз.Жарнаманы өлшеу пайдаланылғанда, жарнамаларының өнімділігін өлшеу үшін сайттар арасында деректердің шектеулі түрлері (мысалы, tions are not supported here.
     */
