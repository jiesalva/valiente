...
function getSucraseContext(code, options) {
  ...
  if (options.transforms.includes("imports")) {
    ...
    // Shadowed globa�оштовно.Завантажте Microsoft Edge на свій телефон безкоштовноСкористайтеся цим посиланням, щоб завантажити Microsoft Edge на свій мобільний п�